...
<div class="form-group has-icon has-label">
    ...
    {!! BSForm::text('pick_at', old('pick_at', isset($reservation->pick_at) ? $reservation->pick_at->format('d.m.Y') : ''), ['id'=>'pick_at', 'placeholder'=>Carbon::now()->format('d.m.Y')]) !!}
...
<div class="form-group has-icon has-label">
    ...
    {!! BSForm::text('drop_at', old('drop_at', isset($reservation->drop_at) ? $reservation->drop_at->format('d.m.Y') : ''), ['id'=>'drop_at', 'placeholder'=>Carbon::now()->format('d.m.Y')]) !!}
    <span class="form-control-icon"><i class="fa fa-calendar"></i></span>

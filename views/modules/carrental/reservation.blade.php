            ...
            <div class="row">
                ...
                <div class="col-md-9 content" id="content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has("tc_no") ? ' has-error' : '' }}">
                                {!! BSForm::text('tc_no', old('tc_no'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.tc_no')]) !!}
                                {!! $errors->first("tc_no", '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has("first_name") ? ' has-error' : '' }}">
                                {!! BSForm::text('first_name', old('first_name'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.first_name')]) !!}
                                {!! $errors->first("first_name", '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has("last_name") ? ' has-error' : '' }}">
                                {!! BSForm::text('last_name', old('last_name'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.last_name')]) !!}
                                {!! $errors->first("last_name", '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="col-md-4 m-top-10">
                            <div class="form-group{{ $errors->has("phone") ? ' has-error' : '' }}">
                                {!! BSForm::text('phone', old('phone'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.phone')]) !!}
                                {!! $errors->first("phone", '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="col-md-4 m-top-10">
                            <div class="form-group{{ $errors->has("mobile_phone") ? ' has-error' : '' }}">
                                {!! BSForm::text('mobile_phone', old('mobile_phone'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.mobile_phone')]) !!}
                                {!! $errors->first("mobile_phone", '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="col-md-4 m-top-10">
                            <div class="form-group{{ $errors->has("email") ? ' has-error' : '' }}">
                                {!! BSForm::text('email', old('email'), ['class' => 'alt', 'data-toggle'=>'tooltip', 'placeholder'=>trans('carrental::reservations.form.email')]) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! BSForm::textarea('requests', old('requests'), ['class'=>'alt', 'data-toggle'=>'tooltip', 'placeholder'=>'İstekleriniz']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflowed reservation-now">
                        ...
                        {!! BSForm::submit('REZERVASYON YAP', ['class'=>'btn btn-theme pull-right btn-reservation-now']) !!}

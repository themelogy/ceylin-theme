                        ...
                        <div class="media-list">
                            ...
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <a href="mailto:{!! Html::email('musterihizmetleri@ceylinrentacar.com') !!}">{!! Html::email('musterihizmetleri@ceylinrentacar.com') !!}</a>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-body">
                                    <strong>{{ trans('themes::theme.contact.returns and refunds') }}:</strong><br>
                                    <a href="mailto:{!! Html::email('muhasebe@ceylinrentacar.com') !!}">{!! Html::email('muhasebe@ceylinrentacar.com') !!}</a>
                                </div>
                            </div>
                        </div>

...
<!-- Favicon -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ Theme::url('ico/favicon.png') }}">
<link rel="shortcut icon" href="{{ Theme::url('ico/favicon.ico') }}">
<link rel="icon" type="image/x-icon" href="{{ Theme::url('ico/favicon.ico') }}">

<!-- CSS Global -->
{!! Theme::style('vendor/bootstrap/css/bootstrap.min.css') !!}
{!! Theme::style('vendor/bootstrap-select/css/bootstrap-select.min.css') !!}
{!! Theme::style('vendor/fontawesome/css/font-awesome.min.css') !!}

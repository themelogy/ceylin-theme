                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="col-sm-7">
                                                            <div class="form-group has-icon has-label">
                                                                ...
                                                                {!! BSForm::text('pick_at', Carbon::today()->format('d.m.Y'), ['id'=>'pick_at', 'placeholder'=>Carbon::today()->format('d.m.Y')]) !!}
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="col-sm-7">
                                                            <div class="form-group has-icon has-label">
                                                                ...
                                                                {!! BSForm::text('drop_at', Carbon::tomorrow()->format('d.m.Y'), ['id'=>'drop_at', 'placeholder'=>Carbon::tomorrow()->format('d.m.Y')]) !!}
                                                                <span class="form-control-icon"><i class="fa fa-calendar"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">

                ...
                <div class="col-md-3">
                    <div class="widget widget-contact">
                        <div class="logo m-bot-10">
                            <a href="{{ url(locale()) }}"><img src="{!! Theme::url('img/logo.png') !!}" alt="{{ setting('themes::company-name') }}"/></a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="widget widget-links">
                                <h4>KURUMSAL</h4>
                                {!! Menu::render('corporate', \Modules\Theme\Presenters\Ceylin\FooterMenuLinksPresenter::class) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="widget widget-links">
                                <h4>HİZMETLERİMİZ</h4>
                                {!! Menu::render('services', \Modules\Theme\Presenters\Ceylin\FooterMenuLinksPresenter::class) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="widget widget-links">
